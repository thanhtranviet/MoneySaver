 ...
 */
public class ExpenseTabFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, OnMoreListener, View.OnClickListener {
    ...
    private ArrayList<TransactionItem> loadData() {
        ...
        List<KhoanChi> data = db.findAllKhoanChi();
        for (GiaoDich o : data) {
    ...
    public void onFinishAdd(KhoanChi giaodich) {
        db.addKhoanChi(giaodich);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.fabAdd:
                EditKhoanChiDialog dialog = EditKhoanChiDialog.newInstance("", this);
