...
import com.k22.nhom1.moneysaver.fragment.BorrowTabFragment;
 ...
 */
public class EditKhoanVayDialog extends DialogFragment {
    public static final String TAG = "EDIT_BORROW_FRAGMENT_TAG";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String title = getActivity().getString(R.string.new_transaction_borrow);
        ...
        if (!TextUtils.isEmpty(transactionName)) {
            title = getActivity().getString(R.string.edit_transaction_borrow);//"Edit Account Balance";
            giaodich = db.getKhoanVay(transactionName);
            ...
            txt_transaction_partner.setText(giaodich.getChuNo().toString());
            txt_transaction_return_date.setText(dateFormat.format(giaodich.getNgayDuKienTra()));
            isEdit = true;
        } else {
            txt_transaction_date.setText(dateFormat.format(new Date()));
            txt_transaction_return_date.setText(dateFormat.format((new Date())));
        }
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        try {
                            ...
                            giaodich.setNgayDuKienTra(dateFormat.parse(txt_transaction_return_date.getText().toString()));
                        ...
                        giaodich.setChuNo(txt_transaction_partner.getText().toString());

                        ((BorrowTabFragment) _caller).onFinishAdd(giaodich);
                    }
                }
        )
    ...
    public static EditKhoanVayDialog newInstance(String name, Fragment caller) {
        _caller = caller;
        EditKhoanVayDialog f = new EditKhoanVayDialog();
