...
import com.k22.nhom1.moneysaver.fragment.CategoryExpenseRecurringFragment;
 ...
 */
public class EditCategoryExpenseRecurringDialog extends DialogFragment {
    public static final String TAG = "EDIT_CATEGORY_EXPENSE_RECURRING_FRAGMENT_TAG";
    ...
    DB4OProvider db;
    Context mContext;
    HangMucChiDinhKy hangmuc;
    Calendar newCalendar;
    LabelledSpinner spn_recurring;
    boolean isEdit = false;

    public EditCategoryExpenseRecurringDialog() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(categoryName)) {
            ...
            hangmuc = db.getHangMucChiDinhKy(categoryName);
        ...
        b.setPositiveButton(getActivity().getString(R.string.OK),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        ((CategoryExpenseRecurringFragment) getParentFragment()).onFinishAdd(hangmuc);
                    }
                });
    ...
    public static EditCategoryExpenseRecurringDialog newInstance(String categoryName) {
        EditCategoryExpenseRecurringDialog f = new EditCategoryExpenseRecurringDialog();
