...
import com.k22.nhom1.moneysaver.dialog.EditCategoryIncomeRecurringDialog;
 ...
 */
public class CategoryIncomeRecuringFragment extends ListFragment implements View.OnClickListener {
    public static final String TAG = "CATEGORY_INCOME_RECURRING_FRAGMENT_TAG";
    ...
    public CategoryIncomeRecuringFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_category_income_recurring, container, false);
    ...
    private void loadList() {
        list.clear();
        List<HangMucThuDinhKy> result = db.findAllHangMucThuDinhKy();
        for (HangMucThuDinhKy hm : result) {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        EditCategoryIncomeRecurringDialog dialog = EditCategoryIncomeRecurringDialog.newInstance(item.getItemTitle());
        dialog.show(fm, EditCategoryIncomeRecurringDialog.TAG);
    }
    ...
    private void addCategory() {
        FragmentManager fm = getChildFragmentManager();
        EditCategoryIncomeRecurringDialog dialog = EditCategoryIncomeRecurringDialog.newInstance("");
        dialog.show(fm, EditCategoryIncomeRecurringDialog.TAG);
    }

    public void onFinishAdd(HangMucThuDinhKy hm) {
        db.store(hm);
        loadList();
