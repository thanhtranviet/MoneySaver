...
import com.k22.nhom1.moneysaver.fragment.ExpenseTabFragment;
 ...
 */
public class EditKhoanChiDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String title = getActivity().getString(R.string.new_transaction_expense);
        ...
        if (!TextUtils.isEmpty(transactionName)) {
            title = getActivity().getString(R.string.edit_transaction_expense);//"Edit Account Balance";
            giaodich = db.getKhoanChi(transactionName);
    ...
    public static EditKhoanChiDialog newInstance(String name, Fragment caller) {
        _caller = caller;
        EditKhoanChiDialog f = new EditKhoanChiDialog();
