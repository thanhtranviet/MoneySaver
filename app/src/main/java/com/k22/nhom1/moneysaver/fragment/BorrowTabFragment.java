 ...
 */
public class BorrowTabFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, OnMoreListener, View.OnClickListener {
    ...
    private ArrayList<TransactionItem> loadData() {
        ...
        List<KhoanVay> data = db.findAllKhoanVay();
        for (GiaoDich o : data) {
    ...
    public void onFinishAdd(KhoanVay giaodich) {
        db.addKhoanVay(giaodich);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.fabAdd:
                EditKhoanVayDialog dialog = EditKhoanVayDialog.newInstance("", this);
