...
import com.k22.nhom1.moneysaver.dialog.EditCategoryIncomeDialog;
 ...
 */
public class CategoryIncomeFragment extends ListFragment implements View.OnClickListener {
    public static final String TAG = "CATEGORY_INCOME_FRAGMENT_TAG";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_category_income, container, false);
    ...
    private void loadList() {
        list.clear();
        List<HangMucThu> result = db.findAllHangMucThu();

        for (HangMucThu hm : result) {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        EditCategoryIncomeDialog dialog = EditCategoryIncomeDialog.newInstance(item.getItemTitle());
        dialog.show(fm, EditCategoryIncomeDialog.TAG);
    }
    ...
    private void addCategory() {
        FragmentManager fm = getChildFragmentManager();
        EditCategoryIncomeDialog dialog = EditCategoryIncomeDialog.newInstance("");
        dialog.show(fm, EditBalanceDialog.TAG);
    }

    public void onFinishAdd(HangMucThu hm) {
        db.store(hm);
        loadList();
